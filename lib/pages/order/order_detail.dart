  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(getTranslated(context, "invoice_order_detail")),
        actions: <Widget>[
          IconButton(
                      ...
                      child: Column(
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              "${getTranslated(context, "home_subtotal")}: ${orderModelObject.order_subtotal + orderModelObject.order_discount}",
                              style: TextStyle(
                          ...
                          Padding(
                            padding: const EdgeInsets.all(3.0),
                            child: Text(
                              "${getTranslated(context, "cart_discount")}: ${orderModelObject.order_discount}",
                              style: TextStyle(
                                  color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),
                            ),
                          ),
