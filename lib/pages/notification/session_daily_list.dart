...
class SessionDailyDetailList extends StatefulWidget {
  final int sessionId;

  SessionDailyDetailList({this.sessionId});
  @override
  _SessionDailyDetailListState createState() => _SessionDailyDetailListState();
}

class _SessionDailyDetailListState extends State<SessionDailyDetailList> {
                                          ...
                                          child: RichText(
                                            text: TextSpan(
                                                ...
                                                children: [
                                                  TextSpan(
                                                    text:
                                                        "${ol.order_subtotal - ol.order_discount}",
                                                    style: TextStyle(
